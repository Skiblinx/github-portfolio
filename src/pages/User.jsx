...
const User = () => {
  ...
  const { getUserData, user, loading, repos, getRepos } = useContext(GithubContext)
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 mb-8 md:gap-8">
          <div className="custom-card-image mb-6 md:mb-0">
            <div className="rounded-lg shadow-xl card image-full">
              ...
              <div className="absolute bottom-4 ml-3 text-white z-[100]  justify-center">
          ...
          <div className="col-span-2">
            ...
            <div className="flex flex-row justify-between">
              ...
              <div className="w-full rounded-lg shadow-md bg-base-100 stats">
                {twitter_username && (
                  <div className="stat">
                    <div className="stat-title text-md truncate">Twitter (X)</div>
                    <div className="text-lg stat-value truncate">
